...
function (_Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return nextProps.show !== this.props.show || nextState.hasInitialized !== this.state.hasInitialized || nextState.mount !== this.state.mount || nextState.hoverArrow !== this.state.hoverArrow;
    }
  }, {
