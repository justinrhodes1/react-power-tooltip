...
function (_Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return nextProps.show !== this.props.show || nextState.hasInitialized !== this.state.hasInitialized || nextState.mount !== this.state.mount;
    }
  }, {
    ...
    value: function componentDidUpdate() {
      ...
      if (this.state.hasInitialized && this.props.show && !this.state.mount) this.setState({
        mount: true
      });
